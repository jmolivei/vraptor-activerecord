...
import br.com.jrj.plugin.vraptor4.activerecord.Model.JPAQuery;
...
public class JPQL {
    ...
    public JPABase findById(String entity, Object id, ClassLoader loader) throws Exception {
        return (JPABase) em().find(loader.loadClass(entity), id);
    }
