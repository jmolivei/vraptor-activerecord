 ...
 *
 */
public class ActiveRecordAgent {

	private static final Logger logger = LoggerFactory.getLogger(ActiveRecordAgent.class);
   ...
   //     logger.trace("premain method invoked with args: {} and inst: {}", args, inst);
        ...
        instrumentation.addTransformer(new ChangeCodeModel(), true);
    }
